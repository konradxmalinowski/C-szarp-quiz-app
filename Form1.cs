    ...
    public partial class QuizApp : Form
    {
        ...
        public static class QuizData
        {
            public static List<Question> Inf02Questions = new List<Question>
            {
                ...
                new Question { Name = "Which protocol is used for assigning IP addresses dynamically?", A = "DHCP", B = "DNS", Correct = "a" },
                new Question { Name = "What does 'IP' stand for?", A = "Internet Protocol", B = "Internal Process", Correct = "a" },
                new Question { Name = "Which component is responsible for executing instructions?", A = "CPU", B = "RAM", Correct = "a" },
                ...
                new Question { Name = "What is the loopback IP address?", A = "127.0.0.1", B = "192.168.0.1", Correct = "a" },
            ...
            public static List<Question> Inf03Questions = new List<Question>
            {
                ...
                new Question { Name = "Which tag defines a table row in HTML?", A = "<tr>", B = "<td>", Correct = "a" },
                ...
                new Question { Name = "Which database system is relational?", A = "MySQL", B = "MongoDB", Correct = "a" },
                new Question { Name = "Which language is used for client-side scripting?", A = "JavaScript", B = "PHP", Correct = "a" },
                new Question { Name = "What does SQL stand for?", A = "Structured Query Language", B = "System Question Language", Correct = "a" },
            ...
            public static List<Question> Inf04Questions = new List<Question>
            {
                ...
                new Question { Name = "Which language is used to build iOS apps?", A = "Swift", B = "Java", Correct = "a" },
                ...
                new Question { Name = "What is Xamarin used for?", A = "Mobile app development", B = "Web hosting", Correct = "a" },
                ...
                new Question { Name = "What is MVVM in software development?", A = "Model View ViewModel", B = "Main Variable View Model", Correct = "a" },
            ...
            public static List<Question> ItQuestions = new List<Question>
            {
                ...
                new Question { Name = "Which device is an output device?", A = "Monitor", B = "Keyboard", Correct = "a" },
                new Question { Name = "Which of the following is a type of software?", A = "Spreadsheet", B = "Printer", Correct = "a" },
                ...
                new Question { Name = "Which programming language is mainly used for web scripting?", A = "JavaScript", B = "C#", Correct = "a" },
            ...
            public static List<Question> GermanQuestions = new List<Question>
            {
                ...
                new Question { Name = "How do you say 'goodbye' in German?", A = "Auf Wiedersehen", B = "Hallo", Correct = "a" },
